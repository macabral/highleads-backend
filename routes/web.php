...
$router->get('/api/emails', ['uses' => 'EmailsController@index','as' => 'emails']);
$router->get('/api/contatos', ['uses' => 'ContatosController@index','as' => 'contatos']);
$router->get('/api/sites', ['uses' => 'SitesController@index','as' => 'sites']);
